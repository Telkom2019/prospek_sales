      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> Movin</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Indihome Gamer</a></li>
            ...
            <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Indihome Smart</a></li>
